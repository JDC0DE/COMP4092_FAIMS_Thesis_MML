...
def define_flags():
    TFLITE_MODEL_FILE_PATH = '../Demo/saved_models/tfLite_sequential.tflite'
    LABELS_PATH = '../Demo/labels.txt'
    OUTPUT_PATH = '../Demo/saved_models'
...
_MODEL_INFO = {
    "tfLite_sequential.tflite":
        ModelSpecificInfo(
            name="Sequential image classifier",
            version="v1",
            image_width=180,
            image_height=180,
            image_min=0,
